...
sections:
  ...
  - block: collection
    ...
    content:
      ...
      text: 'Authors are listed alphabetically by last name, as is the standard in theoretical computer science. Exceptions use * to indicate equal or first authorship.'
      filters:
        folders:
          - publications
